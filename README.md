...
under settings/privacy you can also disable some annoyance feature like anonym stats. If you wish to use Android you may want to use [Kiwi Browser](https://play.google.com/store/apps/details?id=com.kiwibrowser.browser), check for apk if is not available, for Android TV you most probably will need a usb mouse.)
...
*EmuParadise Download Workaround - KAADIVVVV - vvvvid.it Anti-Adblock Killer - YouTube Anti-AdBlock Bypass via YouTube Enhancer (disabled but you can turn it on from the list, if you do so you probably will need to disable AdGuard for youtube) - Simple YouTube Age Restriction Bypass*
